...
public class PolygonUtil {
    ...
    public static double getPolygonAreaSqMts(final List<LatLng> locations) {
        return calculateArea(locations, EARTH_RADIUS);
    }

    public static double getPolygonAreaSqFeet(final List<LatLng> locations) {
        return calculateArea(locations, EARTH_RADIUS * 3.28084);
    }

    private static double calculateArea(final List<LatLng> locations, final double radius) {
        if (locations.size() < 3) {
            return 0;
        }
